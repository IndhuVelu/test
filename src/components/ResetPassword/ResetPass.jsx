...
class Resetpass extends Component {
    ...
    handleChangePass = (e) => {
        ...
        if (this.state.newpass === this.state.confrimpass) {
            fetch('http://localhost:3060/ResetEmail', {
                method: "POST",
                body: JSON.stringify({newpass: this.state.password, confrimpass: this.state.confrimpassword, Email_id: this.props.match.params.id}),
                    headers: {
                            ...
                            <center>
                                ...
                                <div>
                                    ...
                                    <input
                                        className="hi"
                                        type="image"
                                        src="https://cdn3.iconfinder.com/data/icons/show-and-hide-password/100/show_hide_password-10-512.png"
                                        alt="eyeimage"
                                ...
                                <div>
                                    <button id="btn3" onClick={e => this.handleChangePass(e)}>Change Password</button>
                                </div>
