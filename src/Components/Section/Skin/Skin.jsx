...
class Skin extends Component {
    constructor(props) {
        ...
        this.state = {
         makeup:[{id:1,image:phone1,name:"Hair Clib",rate:"$10000"},{id:2,image:phone2,name:"Hair Oil",rate:"$8000"},
         {id:3,image:phone3,name:"Hair Dryer",rate:"$9000"},
         {id:4,image:phone4,name:"Hair Band",rate:"$10000"}]
        }
    }
    handleBook = (e) => {
    ...
    render() {
        return (
            <div className="mobile">
                ...
                <div className="board-heading"><i className="fa fa-user">&nbsp; Featured Hair Brands</i> <br/></div>
