const router=(app)=>{
    ...
    app.post('/head',(req,res)=>{
      ...
      app.post('/UserToAdmin',async function(req,res){
        console.log(req.body)
        var result=await Signup.UserToAdmin(req,res);
        res.send(result)
    
      });
      app.post('/AdminToUser',async function(req,res){
        console.log(req.body)
        var result=await Signup.AdminToUser(req,res);
        res.send(result)
